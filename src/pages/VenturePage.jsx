  ...
  if (!property) {
    return (
      <div className="min-h-screen bg-[#F9F7F2] flex flex-col items-center justify-center text-center p-8">
        ...
        <Link to="/" className="px-6 py-3 rounded-xl bg-[#1B1C1C] text-white font-sans font-bold text-sm">
    ...
    <div className="min-h-screen bg-[#F9F7F2] font-sans">
      ...
      <div className="bg-white border-b border-[#E5E0D5] px-4 sm:px-8 py-3.5 sticky top-20 z-30">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <Link
            to="/"
            className="flex items-center space-x-2 text-xs font-sans font-semibold text-[#1B1C1C] hover:text-[#4A5D4E] transition-colors"
          >
            ...
            >
              ...
              <div className="p-5 space-y-2 flex-1 flex flex-col justify-between">
                ...
                <div className="pt-3 border-t border-[#E5E0D5] flex items-center justify-between">
                  <span className="text-xs font-sans font-bold text-[#1B1C1C]">{v.pricePerSqYd}</span>
                  <span className="text-xs font-sans font-bold text-[#4A5D4E] group-hover:translate-x-1 transition-transform">
                    VIEW VENTURE →
                  </span>
                </div>
              </div>

  ...
  return (
    <section id="trust" className="py-20 bg-[#F9F7F2] relative border-t border-[#E5E0D5]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 p-6 rounded-3xl bg-white border border-[#E5E0D5] flex flex-wrap items-center justify-around gap-6 text-center shadow-sm font-sans">
          <div>
            <p className="eyebrow-tag text-[#636863]">Approved Body</p>
            <p className="text-xl font-bold text-[#4A5D4E] font-serif">DTCP Approved</p>
          </div>
          <div className="hidden sm:block h-8 w-px bg-[#E5E0D5]"></div>
          <div>
            <p className="eyebrow-tag text-[#636863]">Urban Development</p>
            <p className="text-xl font-bold text-[#4A5D4E] font-serif">VMRDA Layouts</p>
          </div>
          <div className="hidden sm:block h-8 w-px bg-[#E5E0D5]"></div>
          <div>
            <p className="eyebrow-tag text-[#636863]">Real Estate Authority</p>

    ...
    <footer className="bg-[#1A1A1A] text-white pt-16 pb-8 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 pb-12 border-b border-[#2E2E2E]">
          ...
          {/* Column 4: Contact & Dual Branches */}
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-xs text-[#9CA3AF]">
              <li className="flex items-start gap-2">
                <MapPin className="w-3.5 h-3.5 shrink-0 mt-0.5 text-[#C8312A]" aria-hidden="true" />
                <div>
                  <strong className="text-white block font-sans">Rajahmundry HQ:</strong>
                  <span>Lalacheruvu, Rajahmundry - 533106</span>
                </div>
              </li>
              <li className="flex items-start gap-2">
                <MapPin className="w-3.5 h-3.5 shrink-0 mt-0.5 text-[#C8312A]" aria-hidden="true" />
                <div>
                  <strong className="text-white block font-sans">Kakinada Branch:</strong>
                  <span>Achampeta Junction, Kakinada - 533005</span>
                </div>
              </li>
              <li className="flex items-center gap-2 pt-1 border-t border-[#2E2E2E]">
                <Phone className="w-3.5 h-3.5 shrink-0 text-[#C8312A]" aria-hidden="true" />
                <a href="tel:+919851633333" className="hover:text-white transition-colors font-semibold text-white">
                  +91 98516 33333
                </a>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="w-3.5 h-3.5 shrink-0 text-[#C8312A]" aria-hidden="true" />

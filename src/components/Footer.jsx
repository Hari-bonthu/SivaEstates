  ...
  return (
    <footer className="bg-[#F9F7F2] pt-12 pb-8 px-4 sm:px-6 lg:px-8 overflow-hidden font-sans">
      <div className="max-w-7xl mx-auto">
            ...
            <div className="lg:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-8 sm:gap-10">
              ...
              <div className="space-y-3.5 col-span-2 sm:col-span-1">
                ...
                <ul className="space-y-2.5 text-xs text-slate-300 font-sans">
                  ...
                  <li className="pt-1">
                    <a href="tel:+919851633333" className="text-xs font-mono font-bold text-[#DBCBB0] hover:underline block">
                      +91 98516 33333
                    </a>
                  </li>
                </ul>
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono text-[#636863]">
          <p>© 2026 Siva Telugu Estates. All rights reserved.</p>

          <button
            onClick={scrollToTop}
            className="flex items-center space-x-1.5 px-3 py-1.5 rounded-lg bg-white border border-[#E5E0D5] hover:bg-[#1B1C1C] hover:text-white text-[#1B1C1C] transition-all cursor-pointer shadow-xs text-xs font-mono font-bold"
            title="Scroll to top"
          >
